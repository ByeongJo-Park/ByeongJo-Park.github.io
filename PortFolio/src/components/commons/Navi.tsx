...
const Navi: React.FC = () => {
    ...
    return (
        <nav className="w-40 h-28 m-2 mt-32 p-2 sticky top-0 z-10 flex flex-col border border-point-gray rounded-xl bg-light-black text-point-gray font-frs-b box-border">
