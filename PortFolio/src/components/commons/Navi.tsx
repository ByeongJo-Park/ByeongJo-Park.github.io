...
const Navi: React.FC = () => {
  ...
  return (
    <nav className="w-40 h-[82px] p-2 mx-4 sticky top-0 z-10 flex flex-col border border-point-gray rounded-xl bg-light-black text-point-gray font-frs-b box-border">
      {menuItems.map((item) => (
        <button
          key={item.view}
